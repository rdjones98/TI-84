...
StateYEquals.prototype.getDataArray = function()
{
	return this._equations;
};
StateYEquals.prototype.getRow = function()
{
	return this._row;
};
StateYEquals.prototype.getCol = function()
{
	return this._col;
};
StateYEquals.prototype.setCol = function(aNum)
{
	this._col = aNum;
};
StateYEquals.prototype.incrRow = function(aNum)
	{
...
StateYEquals.prototype.repaint = function()
		{
			...
			var x = this.CANVAS.X + this.OFFSET + this._col*this.CANVAS.DIGIT_W
